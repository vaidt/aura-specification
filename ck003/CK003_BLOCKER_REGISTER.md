...
| DQ-004 — event-type semantics | `READY` | The semantic contract is defined, the repository now has one controlled draft registry token, a bound fixture, and a local CONF-012 gate. | Extend the registry beyond the local draft token and collect RI-PY / RI-RS evidence before release-grade closure. | `/home/runner/work/aura-specification/aura-specification/ck003/DQ-004_EVENT_TYPE_SEMANTICS.md`, `/home/runner/work/aura-specification/aura-specification/aps/EVENT_TYPE_REGISTRY.md` |
