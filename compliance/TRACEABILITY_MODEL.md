...
| FIX-001 evidence publication content is still TODO | Yes — blocks CONF-001 from release-grade closure even though the draft request/result payload is now bound | High |
