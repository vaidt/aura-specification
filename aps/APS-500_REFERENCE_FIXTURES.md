...
|---|---|---|---|---|
| `fixtures/core/FIX-001_BASIC_EVALUATION.json` | WORKING | `CONF-001` | request/result payload and current draft `EPR-CORE` evidence content are now concrete | controlled execution evidence + explicit APS-500 promotion |
